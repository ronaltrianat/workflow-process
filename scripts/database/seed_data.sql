...
insert into users(name, surname, age, email, document_number, password, fk_user_status_id, address, fk_document_type_id) 
values ('Ronal', 'Triana', 30, 'ronaltriana.t@gmail.com', '1093884556', '$2a$10$lxjw1F6NujiIthrktf00ReBaqukdBG/gWAHNwx3Y8eSAHL.sTg3hy', 1, 'Bogota', 'CC');
